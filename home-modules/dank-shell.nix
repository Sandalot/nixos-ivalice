{ config, pkgs, lib, ... }:
{
  options.modules.dms.enable = lib.mkEnableOption "dms";
  ...
  config = lib.mkIf config.modules.dms.enable {
    programs.dank-material-shell = {
      ...
      settings =
      {
            ...
            popoutCustomAnimationDuration = 220;
            modalAnimationSpeed = 4;
            modalCustomAnimationDuration = 220;
            ...
            systemTrayIconTintSaturation = 65;
            ...
            greeterFontFamily = "Iosevka Nerd Font Mono";
